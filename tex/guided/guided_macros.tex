\usepackage{amsmath,amssymb,xfrac}%math support
\usepackage{stmaryrd}
\usepackage{verbatim}
\usepackage{mdwlist}%提供紧凑的列表
\usepackage{graphicx,tikz,subfig}%picture
\usepackage{ifthen}
...
\usepackage{tabularx,booktabs,array,longtable}%table
...
\def\mytitle#1{\centerline{\heiti\Large #1}}
...
\setlength\mathsurround{0.3ex}%数学模式与文本模式混排时留出的间距
